...
By default the template creates a single `HelloWorld` contract under supply_chain_tracer folder in the `smart_contracts` directory. To add a new contract:
